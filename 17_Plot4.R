...
mem_h_10<- read.table("/path/to/file/mem_hdf5_10_40.txt", header=TRUE, quote="\"")
h_10 <- mem_h_10[,c(1,9)]
...
mem_h_100<- read.table("/path/to/file/mem_hdf5_100_40.txt", header=TRUE, quote="\"")
...
mem_h_200<- read.table("/path/to/file/mem_hdf5_200_40.txt", header=TRUE, quote="\"")
...
mem_h_300<- read.table("/path/to/file/mem_hdf5_300_40.txt", header=TRUE, quote="\"")
...
mem_h_600<- read.table("/path/to/file/mem_hdf5_600_40.txt", header=TRUE, quote="\"")
...
mem_h_all<- read.table("/path/to/file/mem_hdf5_1300_40.txt", header=TRUE, quote="\"")
...
mem_h_10<- read.table("/path/to/file/mem_hdf5_10_10.txt", header=TRUE, quote="\"")
h_10 <- mem_h_10[,c(1,9)]
h_10$RSS <- gsub("G", "000000", h_10$RSS)
h_10$RSS <- gsub("M","000", h_10$RSS)
h_10$RSS <- gsub("K","", h_10$RSS)
...
mem_h_100<- read.table("/path/to/file/mem_hdf5_100_10.txt", header=TRUE, quote="\"")
h_100 <- mem_h_100[,c(1,9)]
h_100$RSS <- gsub("G", "000000", h_100$RSS)
h_100$RSS <- gsub("M","000", h_100$RSS)
h_100$RSS <- gsub("K","", h_100$RSS)
...
mem_h_200<- read.table("/path/to/file/mem_hdf5_200_10.txt", header=TRUE, quote="\"")
h_200 <- mem_h_200[,c(1,9)]
h_200$RSS <- gsub("G", "000000", h_200$RSS)
h_200$RSS <- gsub("M","000", h_200$RSS)
h_200$RSS <- gsub("K","", h_200$RSS)
...
mem_h_300<- read.table("/path/to/file/mem_hdf5_300_10.txt", header=TRUE, quote="\"")
h_300 <- mem_h_300[,c(1,9)]
h_300$RSS <- gsub("G", "000000", h_300$RSS)
h_300$RSS <- gsub("M","000", h_300$RSS)
h_300$RSS <- gsub("K","", h_300$RSS)
...
mem_h_600<- read.table("/path/to/file/mem_hdf5_600_10.txt", header=TRUE, quote="\"")
h_600 <- mem_h_600[,c(1,9)]
h_600$RSS <- gsub("G", "000000", h_600$RSS)
h_600$RSS <- gsub("M","000", h_600$RSS)
h_600$RSS <- gsub("K","", h_600$RSS)
...
mem_h_all<- read.table("/path/to/file/mem_hdf5_1300_10.txt", header=TRUE, quote="\"")
h_all <- mem_h_all[,c(1,9)]
h_all$RSS <- gsub("G", "000000", h_all$RSS)
h_all$RSS <- gsub("M","000", h_all$RSS)
h_all$RSS <- gsub("K","", h_all$RSS)
...
mem_h_10<- read.table("/path/to/file/mem_matrix_10.txt", header=TRUE, quote="\"")
h_10 <- mem_h_10[,c(1,9)]
h_10$RSS <- gsub("G", "000000", h_10$RSS)
h_10$RSS <- gsub("M","000", h_10$RSS)
h_10$RSS <- gsub("K","", h_10$RSS)
...
mem_h_100<- read.table("/path/to/file/mem_matrix_100.txt", header=TRUE, quote="\"")
h_100 <- mem_h_100[,c(1,9)]
h_100$RSS <- gsub("G", "000000", h_100$RSS)
h_100$RSS <- gsub("M","000", h_100$RSS)
h_100$RSS <- gsub("K","", h_100$RSS)
...
mem_h_200<- read.table("/path/to/file/mem_matrix_200.txt", header=TRUE, quote="\"")
h_200 <- mem_h_200[,c(1,9)]
h_200$RSS <- gsub("G", "000000", h_200$RSS)
h_200$RSS <- gsub("M","000", h_200$RSS)
h_200$RSS <- gsub("K","", h_200$RSS)
...
mem_h_300<- read.table("/path/to/file/mem_matrix_300.txt", header=TRUE, quote="\"")
h_300 <- mem_h_300[,c(1,9)]
h_300$RSS <- gsub("G", "000000", h_300$RSS)
h_300$RSS <- gsub("M","000", h_300$RSS)
h_300$RSS <- gsub("K","", h_300$RSS)
...
mem_h_600<- read.table("/path/to/file/mem_matrix_600.txt", header=TRUE, quote="\"")
h_600 <- mem_h_600[,c(1,9)]
h_600$RSS <- gsub("G", "000000", h_600$RSS)
h_600$RSS <- gsub("M","000", h_600$RSS)
h_600$RSS <- gsub("K","", h_600$RSS)
...
mem_h_all<- read.table("/path/to/file/mem_matrix_all.txt", header=TRUE, quote="\"")
h_all <- mem_h_all[,c(1,9)]
h_all$RSS <- gsub("G", "000000", h_all$RSS)
h_all$RSS <- gsub("M","000", h_all$RSS)
h_all$RSS <- gsub("K","", h_all$RSS)
...
mem_h_10<- read.table("/path/to/file/mem_pca_10.txt", header=TRUE, quote="\"")
h_10 <- mem_h_10[,c(1,9)]
h_10$RSS <- gsub("G", "000000", h_10$RSS)
h_10$RSS <- gsub("M","000", h_10$RSS)
h_10$RSS <- gsub("K","", h_10$RSS)
...
mem_h_100<- read.table("/path/to/file/mem_pca_100.txt", header=TRUE, quote="\"")
h_100 <- mem_h_100[,c(1,9)]
h_100$RSS <- gsub("G", "000000", h_100$RSS)
h_100$RSS <- gsub("M","000", h_100$RSS)
h_100$RSS <- gsub("K","", h_100$RSS)
...
mem_h_200<- read.table("/path/to/file/mem_pca_200.txt", header=TRUE, quote="\"")
h_200 <- mem_h_200[,c(1,9)]
h_200$RSS <- gsub("G", "000000", h_200$RSS)
h_200$RSS <- gsub("M","000", h_200$RSS)
h_200$RSS <- gsub("K","", h_200$RSS)
...
mem_h_300<- read.table("/path/to/file/mem_pca_300.txt", header=TRUE, quote="\"")
h_300 <- mem_h_300[,c(1,9)]
h_300$RSS <- gsub("G", "000000", h_300$RSS)
h_300$RSS <- gsub("M","000", h_300$RSS)
h_300$RSS <- gsub("K","", h_300$RSS)
...
mem_h_600<- read.table("/path/to/file/mem_pca_600.txt", header=TRUE, quote="\"")
h_600 <- mem_h_600[,c(1,9)]
h_600$RSS <- gsub("G", "000000", h_600$RSS)
h_600$RSS <- gsub("M","000", h_600$RSS)
h_600$RSS <- gsub("K","", h_600$RSS)
...
mem_h_all<- read.table("/path/to/file/mem_pca_all.txt", header=TRUE, quote="\"")
h_all <- mem_h_all[,c(1,9)]
h_all$RSS <- gsub("G", "000000", h_all$RSS)
h_all$RSS <- gsub("M","000", h_all$RSS)
h_all$RSS <- gsub("K","", h_all$RSS)
