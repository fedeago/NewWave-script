...
# dati <-dati[hvg,]
#310515
path <- paste0("/mnt/temp1/BICCN_data/performance/results/30_thousand/performance_gene_allmini",args,".Rdata")
n_cell <- 30000
...
assign(paste("stat_gene_allmini", args,sep=""), cbind(time_newWave_genemini_all[3],
                           nAIC_genemini_all,
                           nBIC_genemini_all,
                           sil_genemini_all,
                           ari_genemini_all))
filename <- paste("stat_gene_allmini", args,sep="")
