...
path <- paste0("/mnt/federico/BICCN_data/performance/results/",n_cell/1000,"_thousand/performance_com_allmini_random",args,".Rdata")
...
time_newWave_comm_allmini<- system.time(res_newWave_commo_allminibatch <- newFit(dati, K=10,
                                                                                 X = "~batch", 
                                                                                 children = 10, n_gene_disp=100, random_start = T,
...
assign(paste("stat_com_allmini_random", args,sep=""), cbind(time_newWave_comm_allmini[3],
                                                     nAIC_mini_all,
                                                     nBIC_mini_all,
                                                     ari_mini_all))
filename <- paste("stat_com_allmini_random", args,sep="")
